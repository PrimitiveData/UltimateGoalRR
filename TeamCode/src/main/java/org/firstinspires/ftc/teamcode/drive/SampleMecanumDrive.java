...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(14, 0, 0.8);
    ...
    public MinVelocityConstraint velConstraint;
    public ProfileAccelerationConstraint accelConstraint;
    ...
    public double getRawExternalHeading() {
        return analogGyro.getAngleCorrected();
    }
