...
public class AutoAim2 extends Thread {
    ...
    public AutoAim2(HardwareMecanum hardware, Telemetry telemetry, LinearOpMode parentOP){
    ...
    public void run(){
        while(!parentOP.isStopRequested()&&!stopRequested) {
            ...
            hardware.turret.turretPID.setState(MathFunctions.keepAngleWithinSetRange(-Math.toRadians(240), Math.toRadians(120),angleToGoal-hardware.getAngle()));
            telemetry.update();
        }
    }
}
