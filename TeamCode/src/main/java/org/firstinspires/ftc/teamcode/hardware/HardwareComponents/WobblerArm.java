...
public class WobblerArm {
    ...
    public double armGrabWobblePos=0.05;
    public double armRaiseWobble=0.58;
    public double armStartingPos=0.717;
    public double armRestingPos=0.9;
    public double armDropPos = 0.15;
