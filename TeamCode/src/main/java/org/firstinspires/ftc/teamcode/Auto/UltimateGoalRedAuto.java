...
public class UltimateGoalRedAuto extends AutoMethods {
    ...
    public void runOpMode(){
        ...
        double ps1TurretAngle=-Math.toRadians(189.5);
        double ps3TurretAngle=-Math.toRadians(183);
        double ps2TurretAngle=-Math.toRadians(175.5);
